...
Builder.prototype = {
    ...
    templating: function ( config, callback )
    {
        ...
        for ( i = 0; i < tables[ 0 ].length; ++i )
        {
            ...
            console.log( file, self.template.table( tables[ 0 ][ i ], fColumns[ tables[ 0 ][ i ] ][ 0 ] ) );
            ...
            console.log( file, self.template.engine( tables[ 0 ][ i ], fEngines[ 0 ][ tables[ 0 ][ i ] ] ) );
            console.log( file, self.template.keys( tables[ 0 ][ i ], self.buildArr( fKeys[ 0 ][ tables[ 0 ][ i ] ] ) ) );
        }
        ...
        for ( kI = 0; kI < oKeys.length; ++kI )
        {
            ...
            if ( columns[ oKeys[ kI ] ][ 0 ][ 0 ].length > 0 )
            {
                ...
                console.log( file, self.template.columns( oKeys[ kI ], columns[ oKeys[ kI ] ][ 0 ][ 0 ] ) );
        ...
        for ( kI = 0; kI < oKeys.length; ++kI )
        {
            ...
            if ( tsp[ oKeys[ kI ] ].indizies )
            {
                if ( Object.keys( tsp[ oKeys[ kI ] ].indizies[ 2 ] ).length )
                    console.log( file, self.template.changeKeys( oKeys[ kI ], tsp[ oKeys[ kI ] ].indizies[ 2 ] ) );
            }

            //changing engine
            if ( tsp[ oKeys[ kI ] ].engine && tsp[ oKeys[ kI ] ].engine[ 1 ] )
                console.log( file, self.template.engine( oKeys[ kI ], tsp[ oKeys[ kI ] ].engine ) );
        }
        ...
        for ( i = 0; i < tables[ 1 ].length; ++i )
        {
            ...
            console.log( file, self.template.table( tables[ 1 ][ i ], fColumns[ tables[ 1 ][ i ] ][ 1 ], true ) );

            self.write( file, self.template.table( tables[ 1 ][ i ], fColumns[ tables[ 1 ][ i ] ][ 1 ], true ) );

            console.log( file, self.template.engine( tables[ 1 ][ i ], fEngines[ 1 ][ tables[ 1 ][ i ] ], true ) );
            console.log( file, self.template.keys( tables[ 1 ][ i ], self.buildArr( fKeys[ 1 ][ tables[ 1 ][ i ] ] ) ) );
        }
        ...
        for ( kI = 0; kI < oKeys.length; ++kI )
        {
            ...
            if ( columns[ oKeys[ kI ] ][ 0 ][ 0 ].length > 0 )
            {
                ...
                console.log( file, self.template.columns( oKeys[ kI ], columns[ oKeys[ kI ] ][ 0 ][ 0 ], true ) );
